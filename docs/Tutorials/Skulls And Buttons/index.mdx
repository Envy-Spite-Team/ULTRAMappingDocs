...
Skulls are basically the keys of ULTRAKILL. You use them to open doors, activate events, things of that sort. This tutorial will tell you how to set up and use skulls in your own levels.
